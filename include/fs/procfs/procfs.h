...
typedef enum {
    ...
    PFSallocinfo,   /* Linux-style /proc/allocinfo (per-zone allocation stats) */
    PFSapm,         /* Linux-style /proc/apm (advanced power management line) */
    ...
    PFSnfsexports,  /* Linux-style /proc/fs/nfs/exports (NFS export table) */
    PFSinterrupts,  /* Linux-style /proc/interrupts (IRQ topology) */
    ...
    PFSsoftirqs,    /* Linux-style /proc/softirqs (per-CPU softirq counts) */
    ...
    PFSmisc,        /* Linux-style /proc/misc (misc char devices; none on macOS) */
} pfstype;
...
extern int procfs_donettcp(pfsnode_t *pnp, uio_t uio, vfs_context_t ctx);
extern int procfs_donettcp6(pfsnode_t *pnp, uio_t uio, vfs_context_t ctx);
...
extern int procfs_donetarp(pfsnode_t *pnp, uio_t uio, vfs_context_t ctx);
extern int procfs_donetnetstat(pfsnode_t *pnp, uio_t uio, vfs_context_t ctx);
extern int procfs_donetsnmp(pfsnode_t *pnp, uio_t uio, vfs_context_t ctx);
...
extern int procfs_dointerrupts(pfsnode_t *pnp, uio_t uio, vfs_context_t ctx);
extern int procfs_doirq_affinity(pfsnode_t *pnp, uio_t uio, vfs_context_t ctx);
extern int procfs_doirq_affinity_list(pfsnode_t *pnp, uio_t uio, vfs_context_t ctx);
...
extern int procfs_dosoftirqs(pfsnode_t *pnp, uio_t uio, vfs_context_t ctx);
...
extern int procfs_domisc(pfsnode_t *pnp, uio_t uio, vfs_context_t ctx);
